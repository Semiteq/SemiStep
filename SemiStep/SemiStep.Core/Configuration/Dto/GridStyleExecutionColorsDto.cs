...
internal sealed class GridStyleExecutionColorsDto
{
	...
	[YamlMember(Alias = "current_step_marker", ScalarStyle = ScalarStyle.DoubleQuoted)]
	public string? CurrentStepMarker { get; set; }
}
