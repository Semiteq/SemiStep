...
- Вложенные поддействия (поколения): состав строки ветвится в зависимости от выбранного действия и селектора
- Подсветка ячеек с дефолтными значениями при смене действия или селектора
- Панель действий над строками рецепта (тулбар), включается из меню «Вид»

**Конфигурация через YAML**

- Набор столбцов, типы параметров, диапазоны значений, типы действий и визуальный стиль задаются в YAML-файлах
- Встроенный редактор стиля таблицы
- Каждая установка получает собственную конфигурацию; примеры на скриншотах ниже

<div align="center">
    <img src="./Docs/img/visual_style_window.png" width="800" />
    <p><em>Встроенный редактор стиля таблицы</em></p>
</div>
...
<div align="center">
    <img src="./Docs/img/app_connection_example.png" width="800" />
    <p><em>Подключение к ПЛК и панель валидации</em></p>
</div>

- Сообщения об ошибках связи выводятся в панель уведомлений

<div align="center">
    <img src="./Docs/img/app_net_error_example.png" width="800" />
    <p><em>Сообщение об ошибке связи</em></p>
</div>
